...
pub struct RouteStats {
    ...
    pub import_err: u8,
    pub export_err: u8,
    pub skip_regex_tilde: u8,
    pub skip_regex_with_set: u8,
    pub skip_community: u8,
    pub skip_import_empty: u8,
    pub skip_export_empty: u8,
    pub unrec_filter_set: u8,
    pub unrec_as_routes: u8,
    pub unrec_route_set: u8,
    pub unrec_as_set: u8,
    pub unrec_as_set_route: u8,
    pub unrec_some_as_set_route: u8,
    pub unrec_aut_num: u8,
    pub unrec_peering_set: u8,
    pub spec_uphill: u8,
    pub spec_uphill_tier1: u8,
    pub spec_tier1_pair: u8,
    pub spec_import_peer_oifps: u8,
    pub spec_import_customer_oifps: u8,
    pub spec_export_customers: u8,
    pub spec_as_is_origin_but_no_route: u8,
    pub err_filter: u8,
    pub err_filter_as_num: u8,
    pub err_filter_as_set: u8,
    pub err_filter_prefixes: u8,
    pub err_filter_route_set: u8,
    pub err_remote_as_num: u8,
    pub err_remote_as_set: u8,
    pub err_except_peering_right: u8,
    pub err_peering: u8,
    pub err_regex: u8,
    pub rpsl_as_name: u8,
    pub rpsl_filter: u8,
    pub rpsl_regex: u8,
    pub rpsl_unknown_filter: u8,
    pub recursion: u8,
}
